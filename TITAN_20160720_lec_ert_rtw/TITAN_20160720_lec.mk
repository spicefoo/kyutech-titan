...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/TITAN_20160720_lec.elf
...
PRODUCT_NAME              = TITAN_20160720_lec
MAKEFILE                  = TITAN_20160720_lec.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/Deckadance/Documents/kyutech-titan
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = TITAN_20160720_lec_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/TITAN_20160720_lec.elf
...
INCLUDES_BUILDINFO = -IC:/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/arduinobase/include -IC:/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/arduinobase/blocks/sfcn/include -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/TITAN_20160720_lec_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/dsp/include -I$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include/src -I$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include -I$(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -IC:/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/arduinotarget/registry/../include -IC:/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/include
...
DEFINES_ = -DMODEL=TITAN_20160720_lec -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DON_TARGET_WAIT_FOR_START=1 -DEXT_MODE=1 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DONESTEPFCN=1 -DTERMFCN=1 -DMULTI_INSTANCE_CODE=0 -DTID01EQ=1 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DRT -DSTACK_SIZE=64 -D_MW_ARDUINO_LOOP_=1 -DMW_ARDUINO_STEP_SIZE=50000 -DMW_ARDUINO_MICROS -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=TITAN_20160720_lec -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO
...
%.o : $(START_DIR)/TITAN_20160720_lec_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/TITAN_20160720_lec_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(START_DIR)/TITAN_20160720_lec_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
